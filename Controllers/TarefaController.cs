    ...
    public class TarefaController : ControllerBase
    {
        ...
        public IActionResult ObterPorTitulo(string titulo)
        {
            ...
            if (string.IsNullOrEmpty(titulo))
                     return BadRequest("O título não pode ser nulo ou vazio.");
        ...
        public IActionResult ObterPorData(DateTime data)
        {
            ...
            if (tarefa == null || tarefa.Count == 0)
                    return NotFound($"Nenhuma tarefa encontrada para a data informada: {data:dd/MM/yyyy}.");
        ...
        public IActionResult ObterPorStatus(EnumStatusTarefa? status)
        {
            ...
            if (status == null)
                return BadRequest("O status precisa ser informado.");
